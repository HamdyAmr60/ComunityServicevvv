...
export const updateServiceRequestStatus = async (id, status, cancelReason) => {
  const response = await api.put(`/servicerequests/${id}/status`, {
    status,
    cancelReason,
  });
  return response.data;
...
export const getFeaturedRequests = async () => {
  const response = await api.get('/servicerequests/featured');
  return response.data;
};

export const getServiceRequestCategories = async () => {
  const response = await api.get('/servicerequests/categories');
  return response.data;
};

export const getServiceRequestStatistics = async () => {
  const response = await api.get('/servicerequests/statistics');
  return response.data;
};
